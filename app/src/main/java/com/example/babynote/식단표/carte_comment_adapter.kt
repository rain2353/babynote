...
class carte_comment_adapter(
    internal val context: Context,
    internal val carte_comment_list: List<carte_comment_list>
) :
    RecyclerView.Adapter<carte_comment_adapter.Holder>()   {
    lateinit var myAPI: INodeJS
    var compositeDisposable = CompositeDisposable()
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): carte_comment_adapter.Holder {
        val view = LayoutInflater.from(context).inflate(R.layout.notice_comment_item, p0, false)
        return Holder(view)
    }

    override fun getItemCount(): Int {
        return carte_comment_list.size
    }

    override fun onBindViewHolder(p0: carte_comment_adapter.Holder, p1: Int) {
        p0.comment_nickname.text = carte_comment_list[p1].comment_nickname
        p0.comment_time.text = carte_comment_list[p1].comment_time
        p0.comment_content.text = carte_comment_list[p1].comment_content
        ...
        p0.setClick(object : IRecyclerOnClick {
            ...
            override fun onLongClick(view: View, Position: Int) {
                Common.selected_carte_comment = carte_comment_list[Position]
                //Init API
