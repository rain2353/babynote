...
import kotlinx.android.synthetic.main.activity_modify_phone_number.*

class modify_phone_number : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        editText_phonenumber.setText(UserDTO.phone_number)
        modify_phonenumber_button.setOnClickListener {
            if (!editText_phonenumber.text.isEmpty()) {
                compositeDisposable.add(myAPI.modify_myInfo(
                    ...
                    .subscribe { message ->
                        ...
                        imm.hideSoftInputFromWindow(editText_phonenumber.windowToken, 0)
                        finish()

                    })
            } else {
                Toast.makeText(this, "변경하실 휴대전화번호를 작성해주세요.", Toast.LENGTH_SHORT).show()
